    ...
    h('div', {className:'table-container'},
      h('table', null,
        ...
        h('tbody', null,
          ...
          recs.length === 0 ? h('tr', null,
            h('td', {colspan:'7', style:{textAlign:'center',padding:'40px',color:'var(--text-muted)'}},
          ...
          ...alertasFiltradas.map(function(a) {
            ...
            return h('div', {className: 'alerta-item alerta-item-' + a.nivel},
              ...
              h('div', {className: 'alerta-item-dias'},
                ...
                h('button', {className: 'btn btn-sm btn-secondary', style:{marginTop:'8px'}, onClick: function() {
                  // Ir al registro
                  ...
                  STATE.page = 1;
                  render();
                }}, h('i', {className: 'fas fa-eye', style:{marginRight:'4px'}}), 'Ver registro')
              )
            );
          })
        )
